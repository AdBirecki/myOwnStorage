...
namespace InsertionExtension_Tests
{
    public class InsertionSort_test
    {
        ...
        {
            List<int> testData = new List<int> { 4, 7, 2, 1, 12, 16};
            List<int> referenceData = new List<int> {1, 2, 4, 7, 12, 16 };
        ...
        public void TestInsertionSort()
        {
            ...
            List<int> referenceData = new List<int> {1,2,4,5,7,12,22,23,28,31,40,41,42,54};
